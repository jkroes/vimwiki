...
git help -g                     Help guides
git help                        Common subcommands
git help git                    All subcommands and help for git command
git help <command>              <command> help
git <command> --help
man git-<command>
git <command> -h                Abbreviated <command> help
git <command> --help-all        <command> help, plus hidden options
                                such as git init --separate-git-dir
```

If using fish shell, type `git help ` (with the space) then tab for completion
or C-s for filtering completion items.
...
`git log --oneline --graph --all`   Visualize your git history w/ branches
