...
Potential rc.confg hack: Set g:floatterm_open_command to something other than
edit for c-x, c-v, and c-t. Then the floaterm ranger wrapper should execute
whatever command the variable is set to. Then at the end of the shortcut,
attempt to open the files (move right=1?)
